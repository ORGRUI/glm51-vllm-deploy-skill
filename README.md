...
- `azure-amd-deploy-env/`: self-contained Azure AMD MI300X deployment environment constraints and host preparation workflow, including durable/ephemeral disk policy and local NVMe setup.
