...
PY
  ...
  export NORMALIZE_TOOL_CALL_ARGUMENTS DISABLE_THINKING SANITIZE_THINKING_MARKERS MERGE_DEVICES QUANT_DEVICES MERGE_JOBS
...
CAPTURE_PROXY_SANITIZE_THINKING_MARKERS=$SANITIZE_THINKING_MARKERS
CADDY_LISTEN=:7777
