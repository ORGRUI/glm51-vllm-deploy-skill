...
DEFAULT_VLLM_EXTRA_ARGS='--async-scheduling --compilation-config={"cudagraph_mode":"FULL_AND_PIECEWISE"} --enable-prefix-caching --block-size=1'
...
VLLM_ROCM_QUICK_REDUCE_QUANTIZATION="${VLLM_ROCM_QUICK_REDUCE_QUANTIZATION:-INT4}"
...
VLLM_ARGV_ROCM_USE_AITER="${VLLM_ROCM_USE_AITER}" \
VLLM_ARGV_ROCM_QUICK_REDUCE_QUANTIZATION="${VLLM_ROCM_QUICK_REDUCE_QUANTIZATION}" \
VLLM_ARGV_ROCM_USE_AITER_RMSNORM="${VLLM_ROCM_USE_AITER_RMSNORM}" \
...
data = {
    ...
    "rocm_use_aiter": os.environ["VLLM_ARGV_ROCM_USE_AITER"],
    "rocm_quick_reduce_quantization": os.environ["VLLM_ARGV_ROCM_QUICK_REDUCE_QUANTIZATION"],
    "rocm_use_aiter_rmsnorm": os.environ["VLLM_ARGV_ROCM_USE_AITER_RMSNORM"],
...

{
  ...
  printf '  -e VLLM_ROCM_USE_AITER=%q \\\n' "${VLLM_ROCM_USE_AITER}"
  printf '  -e VLLM_ROCM_QUICK_REDUCE_QUANTIZATION=%q \\\n' "${VLLM_ROCM_QUICK_REDUCE_QUANTIZATION}"
  printf '  -e VLLM_ROCM_USE_AITER_RMSNORM=%q \\\n' "${VLLM_ROCM_USE_AITER_RMSNORM}"
